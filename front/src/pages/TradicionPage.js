                ...
                <main>
                    <div className="card mb-4">
                        <div className="card-body">
                            <h5 className="card-title"> Tradición</h5>
                            <p>
                    ...
                    <div className="row row-cols-1 row-cols-md-3 g-4">
                        <div className="col">
                            <div className="card h-100">
                                <img src="image/mate gaucho.jpg" className="card-img-top" alt="Gaucho mateando" />
                                <div className="card-body">
                                    <h5 className="card-title">El Mate Gaucho</h5>
                                    <p className="card-text">En la soledad de su hogar en el campo, el gaucho encuentra en el mate un
                        ...
                        <div className="col">
                            <div className="card h-100">
                                <img src="image/mate sombrero.jpg" className="card-img-top" alt="Chica con un mate" />
                                <div className="card-body">
                                    <h5 className="card-title">El Mate Viajero</h5>
                                    <p className="card-text">Con el sombrero desplegando su encanto, esta viajera se detiene a
                        ...
                        <div className="col">
                            <div className="card h-100">
                                <img src="image/Mateando.jpg" className="card-img-top" alt="Amigos mateando" />
                                <div className="card-body">
                                    <h5 className="card-title">El Mate Compartido</h5>
                                    <p className="card-text">Bajo el cálido abrazo del sol, un grupo de amigos se reúne en el pasto para
