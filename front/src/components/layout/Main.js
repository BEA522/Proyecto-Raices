...
const Main = () => {
    return (
        <div className="container">
            <div className="row">
                <div className="col">
                    <img src="image/Un campo de yerba mate agroecológica..jpg" className="d-block w-100" alt="Yerba en una mesa" />
                </div>
            </div>
            <main>
                <div className="row">
            ...
            <Link to="/Tradicion" className="btn btn-primary">Comienzo y Tradición</Link>
